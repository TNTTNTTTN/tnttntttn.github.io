...
tags: [github pages, seo]     # TAG names should always be lowercase
description: Jekyll 기반 GitHub Pages 블로그를 구글 검색에 노출시키는 방법. Google Search Console에 URL을 등록하고 사이트맵을 제출하는 과정을 단계별로 정리했다.
---
...
### 1. URL 등록
![Google Search Console URL 등록 화면](/assets/post_img/2026-02-18/SearchConsole.png)

Google Search Center에 들어가자마자 보이는 화면이다.

URL 접두어 &rarr; 개인 블로그 주소를 작성하자.

### 2. 소유권 확인 HTML 파일 복사

![Google Search Console 소유권 확인 HTML 파일 안내 화면](/assets/post_img/2026-02-18/AuthCheck.png)
...
![Google Search Console 소유권 확인 완료 화면](/assets/post_img/2026-02-18/AuthConfirm.png)

### 3. Sitemap 추가하기

![Google Search Console 사이트맵 추가 화면](/assets/post_img/2026-02-18/SitemapAdd.png)
...
![Google Analytics 데이터 스트림 설정 화면](/assets/post_img/2026-02-18/DataStream.png)
...
![Google Analytics 측정 ID 발급 화면](/assets/post_img/2026-02-18/Key.png)
...
![블로그와 Google Analytics 연동 완료 화면](/assets/post_img/2026-02-18/Connected.png)
