---
title: 임베디드 스터디 - 디지털 시스템
date: 2026-02-18
categories: [Study, Embedded Hardware]
tags: [digital logic, embedded hardware]     # TAG names should always be lowercase
math: true
description: 임베디드 하드웨어 기초인 디지털 시스템 개요. 불 대수, 카르노맵, BCD/Gray Code 수 표현, IEEE 754 부동소수점 및 고정소수점 표현 방식을 정리했다.
---
...
ex) $AB + \overline{A}BC$ &rarr; $ABC + AB\overline{C} + \overline{A}BC$
...
대표적인 예로 Quine-McCluskey 알고리즘이 있다.
Quine-McCluskey 알고리즘은 카르노맵과 원리는 유사하지만 처리 과정에 알고리즘화 가능함.

Q-M 알고리즘은 모든 항을 2진수로 표현한 뒤, 1의 개수에 따라 각 항을 그룹화하며, 각 그룹에서 **unit distance**인 경우에 대해 간소화를 진행한다.
...
* Gray Code
    ...
    * 기존 2진법의 형태로 수를 나열할 때, 다음 그림과 같이 그레이코드가 변함<br>
    ![2진법과 그레이 코드 대응 관계 시각화 다이어그램](/assets/post_img/2026-02-18/GrayCode.png "By Original: Hyacinth Vector: DustDFG - derived from https://commons.wikimedia.org/wiki/File:Gray_code_number_line_arcs.png, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=142742575")
